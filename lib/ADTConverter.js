...
export default class ADTConverter {
  ...
  async createDefaultDirs() {
    await this.ensureDirectoryExists('./resources/Extractor/export');
    await this.ensureDirectoryExists('./resources/Extractor/Input');
    await this.ensureDirectoryExists('./resources/Heightmap/input');
    await this.ensureDirectoryExists('./resources/Heightmap/Output');
  }
